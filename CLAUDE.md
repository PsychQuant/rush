...
- **Rate limit**: TDX 2026-06 改訂閱制——基礎(免費) **5 次/分**／銅級(200元/月) **5 次/秒**／銀 10/秒／金 30/秒／白金 50/秒。本帳號已訂**銅級**（bus-eta logger ~17 req/分 需 ≥銅級；基礎裝不下）。429 single retry; second 429 returns error
