...
**v0.2-dev** — 24 tools across 6 transport modes (Rail / Bus / Bike / Air / Traffic / Parking) incl. `transit_route` TRA↔Taipei-Metro multi-modal routing
...
- **Read-only**: all 24 tools are GET-only against TDX. No execution risk.
